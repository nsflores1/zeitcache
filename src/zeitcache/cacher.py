...
def zeitcache(fn, var, kwargs=None, name_hint="", cache_dir="./cache"):
    """
    ...
    annual_qrunoff_P = zeitcache(compute_annual_q, total_qrunoff_P, name_hint="annual_qrunoff_P")
    ...
    # TODO: add an arg that lets you switch the value
